...
const CommentModal: React.FC<CommentModalProps> = ({
  ...
  const samplePost = {
    ...
    content:
      "Hôm nay là một ngày tuyệt vời! Vừa hoàn thành xong dự án React Native mới.",
  };
      ...
      <View style={[styles.overlay, { backgroundColor: colors.overlay }]}>
        ...
        >
          ...
          >
            ...
            {/* Post Preview */}
            <View
              style={[styles.postPreview, { borderBottomColor: colors.border }]}
            >
              <View style={styles.postHeader}>
                ...
                >
                  ...
                  >
                    {samplePost.username.charAt(0).toUpperCase()}
                  </Text>
                </View>
