export const watchData = [
  ...
  //   avatar: "G4",
  //   description:
  //     "The Smoking Tire heads out to Adams Motorsports Park in Riverside, CA to test the most requested car of 2010, the Volkswagen GTI. Will it beat the Mazdaspeed3's standard-setting lap time?",
  //   likes: 1200,
  //   comments: 88,
  //   shares: 42,
  //   isLiked: false,
